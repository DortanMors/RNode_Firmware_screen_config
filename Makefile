...
firmware-heltec32_v3_ws:
	arduino-cli compile --log --fqbn esp32:esp32:heltec_wifi_lora_32_V3 -e --build-property "build.partitions=no_ota" --build-property "upload.maximum_size=2097152" --build-property "compiler.cpp.extra_flags=\"-DBOARD_MODEL=0x43\""
...
release-heltec32_v3_ws: check_bt_buffers
	...
	cp ~/.arduino15/packages/esp32/hardware/esp32/$(ARDUINO_ESP_CORE_VER)/tools/partitions/boot_app0.bin build/rnode_firmware_heltec32v3ws.boot_app0
	cp build/esp32.esp32.heltec_wifi_lora_32_V3/RNode_Firmware.ino.bin build/rnode_firmware_heltec32v3ws.bin
	cp build/esp32.esp32.heltec_wifi_lora_32_V3/RNode_Firmware.ino.bootloader.bin build/rnode_firmware_heltec32v3ws.bootloader
	cp build/esp32.esp32.heltec_wifi_lora_32_V3/RNode_Firmware.ino.partitions.bin build/rnode_firmware_heltec32v3ws.partitions
	zip --junk-paths ./Release/rnode_firmware_heltec32v3ws.zip ./Release/esptool/esptool.py ./Release/console_image.bin build/rnode_firmware_heltec32v3ws.boot_app0 build/rnode_firmware_heltec32v3ws.bin build/rnode_firmware_heltec32v3ws.bootloader build/rnode_firmware_heltec32v3ws.partitions
	rm -r build
